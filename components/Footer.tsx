...
export default function Footer() {
  ...
  return (
    <footer
      className="border-t transition-colors duration-300 max-w-[1400px] mx-auto px-6"
      style={{
        ...
        <div className="max-w-7xl mx-auto px-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 relative z-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Home", "About", "Services", "Development Process", "Trusted Companies", "Testimonials", "Why Orfys"].map((item) => (
                <li key={item}>
                  <Link
