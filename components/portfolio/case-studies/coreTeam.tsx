...
const CoreTeam: React.FC<ProjectDataProps> = ({ data }) => {
    return (
        <section id="core-team" className="py-6 md:py-16 bg-[var(--bg-primary)]">
            <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        {/* Render optional intro paragraphs if provided in constants */}
                        ...
                        <ul className="space-y-2">
                            {data.bulletin?.map((member, index) => (
