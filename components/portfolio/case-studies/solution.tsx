...
const Solution: React.FC<ProjectDataProps> = ({ data }) => {
    return (
        <section id="solution" className="py-6 md:py-16 bg-[var(--bg-primary)]">
            <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Bulletin List with "Key Features" label */}
                        <ul className="space-y-2 pt-2">
                            <p className="text-sm md:text-[16px] font-semibold leading-relaxed text-[var(--text-secondary)] mb-2">
                                Key Features
                            </p>
